...
PHASES.append({
 ...
 "vocab": [
  ...
  ("PPE", "/ˌpiː piː ˈiː/", "n", "đồ bảo hộ lao động (personal protective equipment)", "Please wear your <b>PPE</b> before you enter the line.", "Vui lòng mặc đồ bảo hộ trước khi vào chuyền.", "保護具", "hogogu"),
  ...
  ("hazard", "/ˈhæzəd/", "n", "mối nguy hiểm", "Oil on the floor is a slip <b>hazard</b>.", "Dầu trên sàn là mối nguy gây trơn trượt.", "危険", "kiken"),
 ...
 "listen": [
  ...
  ("Good morning, everyone. Yesterday someone slipped near Line 3. Please clean up any oil right away.", ["slipped", "Line", "oil"], "nhắc an toàn đầu ca"),
...
PHASES.append({
 ...
 "vocab": [
  ("production line", "/prəˈdʌkʃn laɪn/", "n", "dây chuyền sản xuất, chuyền", "We have six <b>production lines</b> in this building.", "Tòa nhà này có sáu chuyền sản xuất.", "生産ライン", "seisan rain"),
  ("shift", "/ʃɪft/", "n", "ca làm việc", "I'm on the night <b>shift</b> this week.", "Tuần này tôi làm ca đêm."),
  ("cycle time", "/ˈsaɪkl taɪm/", "n", "thời gian chu kỳ (cho một sản phẩm)", "The <b>cycle time</b> is 45 seconds per unit.", "Thời gian chu kỳ là 45 giây mỗi sản phẩm."),
...
PHASES.append({
 ...
 "vocab": [
  ...
  ("first article", "/ˌfɜːst ˈɑːtɪkl/", "n", "hàng đầu (sản phẩm đầu tiên cần kiểm tra)", "Please check the <b>first article</b> before mass production.", "Vui lòng kiểm tra hàng đầu trước khi sản xuất hàng loạt.", "初品", "shohin"),
 ...
 "phrases": [
  ...
  ("The first article passed inspection.", "Hàng đầu đã đạt kiểm tra."),
 ...
 "listen": [
  ...
  ("QC checked fifty samples from Lot twelve. Three of them had scratches. We will do full inspection today.", ["samples", "scratches", "full"], "báo kết quả kiểm tra"),
  ("This size is out of spec. The tolerance is plus or minus point one millimetre. Please measure it again.", ["size", "tolerance", "measure"], "hàng ngoài tiêu chuẩn"),
 ],
})
...
PHASES.append({
 ...
 "vocab": [
  ...
  ("vibration", "/vaɪˈbreɪʃn/", "n", "độ rung, sự rung", "There's strange <b>vibration</b> in the motor.", "Mô-tơ rung bất thường.", "振動", "shindō"),
 ...
 "dialogues": [
  ("Why did Machine 3 stop?", [
    ...
    ("Machine 3 is broken because it is old.", False, "Đoán nguyên nhân khi chưa kiểm tra — nên nói điều mình thấy."),
...
PHASES.append({
 ...
 "vocab": [
  ...
  ("lead time", "/ˈliːd taɪm/", "n", "thời gian chờ hàng (từ lúc đặt đến lúc nhận)", "The <b>lead time</b> for this material is four weeks.", "Thời gian chờ hàng của vật tư này là bốn tuần."),
  ("forecast", "/ˈfɔːkɑːst/", "n", "dự báo (nhu cầu, đơn hàng)", "The customer sent a new <b>forecast</b> for March.", "Khách hàng đã gửi dự báo mới cho tháng Ba."),
 ...
 "phrases": [
  ...
  ("Can we move this order up to next week?", "Mình đẩy đơn này lên tuần sau được không?"),
...
PHASES.append({
 ...
 "vocab": [
  ...
  ("countermeasure", "/ˈkaʊntəmeʒə/", "n", "biện pháp đối sách", "Our <b>countermeasure</b> is a new jig at Station 3.", "Đối sách của tụi mình là đồ gá mới ở công đoạn 3.", "対策", "taisaku"),
  ...
  ("customer claim", "/ˈkʌstəmə kleɪm/", "n", "khiếu nại chất lượng của khách hàng", "We got a <b>customer claim</b> about loose screws.", "Tụi mình nhận khiếu nại của khách về ốc bị lỏng.", "クレーム", "kurēmu"),
...
PHASES.append({
 ...
 "vocab": [
  ...
  ("trial run", "/ˌtraɪəl ˈrʌn/", "n", "chạy thử", "We'll do a <b>trial run</b> with 50 pieces.", "Tụi mình sẽ chạy thử 50 sản phẩm.", "試運転", "shiunten"),
 ],
 "phrases": [
...
PHASES.append({
 ...
 "vocab": [
  ...
  ("visitor badge", "/ˈvɪzɪtə bædʒ/", "n", "thẻ khách", "Please wear your <b>visitor badge</b> at all times.", "Vui lòng đeo thẻ khách suốt thời gian ở nhà máy."),
  ("factory tour", "/ˈfæktri tʊə/", "n", "chuyến tham quan nhà máy", "The <b>factory tour</b> takes about 40 minutes.", "Chuyến tham quan nhà máy mất khoảng 40 phút."),
 ...
 "phrases": [
  ...
  ("We'll send you the corrective action within two weeks.", "Chúng tôi sẽ gửi hành động khắc phục trong vòng hai tuần."),
 ...
 "listen": [
  ...
  ("The audit found two minor nonconformities. One was in the warehouse. We will send the corrective action by Friday.", ["minor", "warehouse", "Friday"], "tổng kết audit"),
 ],
})
...
PHASES.append({
 ...
 "vocab": [
  ...
  ("certify", "/ˈsɜːtɪfaɪ/", "v", "công nhận (tay nghề), cấp chứng nhận", "Lan was <b>certified</b> for soldering last week.", "Tuần trước Lan được công nhận tay nghề hàn."),
  ("step by step", "/ˌstep baɪ ˈstep/", "adv", "từng bước một", "I'll show you <b>step by step</b>.", "Tôi sẽ chỉ cho bạn từng bước."),
  ("key point", "/ˈkiː pɔɪnt/", "n", "điểm mấu chốt (của thao tác)", "The <b>key point</b> is to hold the part with two hands.", "Điểm mấu chốt là giữ linh kiện bằng hai tay."),
 ...
 "dialogues": [
  ...
  ("How long does it take to train a new operator?", [
    ...
    ("Depends on the person maybe.", False, "Mơ hồ; nên nêu thời gian tiêu chuẩn trước."),
  ]),
 ...
 "listen": [
  ...
  ("Today you will learn Station two. First, read the SOP with me. Then practice on ten sample parts.", ["learn", "read", "practice"], "buổi đào tạo đầu tiên"),
...
ROLES = {
 ...
 "engineer": {"label": "Kỹ sư sản xuất · Bảo trì", "emoji": "🔧",
  ...
  "dialogues": [
   ...
   ("Why do we need to stop the line on Saturday?", [
     ...
     ("Because the plan says.", False, "Chưa giải thích lợi ích — người hỏi muốn biết 'để làm gì'."),
   ...
   ("Can the new jig reduce cycle time?", [
     ...
     ("Yes, very much faster.", False, "Sai ('much faster') và không có số liệu."),
 ...
 "planner": {"label": "Kế hoạch · Kho · Mua hàng", "emoji": "📦",
  "scenarios": [
   ...
   ("pl_supplier", "Hối nhà cung cấp", "You are a supplier's sales person. Your delivery of materials is three days late. I call to ask for the new date. Apologize and give a reason."),
