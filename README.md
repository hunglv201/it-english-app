...
- **Lộ trình theo ngành** — IT 45 chặng · 450 ngày (225 hội thoại, 270 bài nghe, 450 từ); các ngành khác 20 chặng · 200 ngày (100 hội thoại, 120 bài nghe, 200 từ). v4.2: 13 ngành (thêm Giáo dục · Đào tạo, Luật · Hành chính công), boss game cuối mỗi chặng, rảnh tay bằng lệnh giọng nói, ảnh → bộ bài học (đọc chữ trên máy), email tổng kết tuần. v4.3: song ngữ Anh ⇄ Nhật cho IT/BrSE, sổ lỗi cá nhân, chuẩn bị nhanh trước họp/ca/phỏng vấn, 55 mẫu email & tin nhắn theo ngành. Mỗi ngày gồm từ vựng, mẫu câu, hội thoại, bài nghe và phần luyện thêm với AI.
